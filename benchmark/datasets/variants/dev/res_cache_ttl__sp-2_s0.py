...
class CacheTTL:
    ...
    def fn_set(self, key: Any, value: Any, tick: int=0, ttl: Optional[int]=None) -> None:
    ...
    def fetch(self, key: Any, tick: int) -> Optional[Any]:
    ...
    def fn_delete(self, key: Any) -> None:
    ...
    def fn_expire_all(self, tick: int) -> int:
