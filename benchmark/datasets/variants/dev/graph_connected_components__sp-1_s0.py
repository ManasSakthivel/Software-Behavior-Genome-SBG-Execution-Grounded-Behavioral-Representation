...
class UnionFind:
    ...
    def __init__(self, nodes):
        self.parent = {num: num for num in nodes}
        self.rank = {num: 0 for num in nodes}
    ...
    def union(self, val, yval):
        (rx, ry) = (self.find(val), self.find(yval))
        if rx == ry:
            return
    ...
    def components(self) -> List[Set]:
        ...
        for vertex in self.parent:
            ...
            groups.setdefault(root, set()).add(vertex)
