...
class EventBus:
    ...
    def fn_subscribe(self, topic: str, handler: Callable[[Event], None], filter_fn: Optional[Callable[[Event], bool]]=None) -> int:
        """
    ...
    def fn_unsubscribe(self, subscription_id: int) -> None:
    ...
    def fn_publish(self, topic: str, payload: Any, tick: int=None) -> int:
        """
    ...
    def fn_publish_batch(self, events: List[Tuple[str, Any]]) -> List[Tuple[str, int]]:
    ...
    def fn_replay(self, topic: str, n: Optional[int]=None) -> List[Event]:
