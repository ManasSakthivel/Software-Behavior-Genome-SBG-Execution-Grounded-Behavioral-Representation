...
class TrafficLight:
    ...
    @property
    def fn_state(self) -> TrafficState:
        return self._state

    @property
    def fn_total_ticks(self) -> int:
        return self._total_ticks

    @property
    def fn_history(self) -> List[Tuple[int, TrafficState]]:
        return list(self._history)

    def fn_tick(self) -> TrafficState:
    ...
    def fn_trigger_emergency(self) -> None:
