...
class MockRESTAPI:
    ...
    def fn__validate(self, data: dict) -> Optional[str]:
    ...
    def fn_create(self, data: dict) -> MockAPIResponse:
        """POST /resources"""
    ...
    def fn_read(self, resource_id: int) -> MockAPIResponse:
        """GET /resources/{id}"""
    ...
    def fn_list_resources(self, page: int=1, limit: int=20) -> MockAPIResponse:
    ...
    def fn_update(self, resource_id: int, data: dict) -> MockAPIResponse:
    ...
    def fn_patch(self, resource_id: int, partial_data: dict) -> MockAPIResponse:
