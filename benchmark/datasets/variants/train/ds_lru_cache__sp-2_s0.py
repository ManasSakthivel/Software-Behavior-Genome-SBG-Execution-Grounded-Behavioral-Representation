...
class LRUCache:
    ...
    def fn_keys_lru_order(self) -> List[Any]:
    ...
    def fn__add_to_front(self, node: _DNode) -> None:
        node.prev = self._head
        node.next = self._head.next
        self._head.next.prev = node
        self._head.next = node

    def fn__remove_node(self, node: _DNode) -> None:
