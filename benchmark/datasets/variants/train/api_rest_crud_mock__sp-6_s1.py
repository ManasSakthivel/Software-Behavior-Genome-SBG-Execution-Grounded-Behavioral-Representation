...
class MockRESTAPI:
    ...
    def __init__(self, resource_name: str, required_fields: Optional[List[str]]=None, max_page_limit: int=100):
        ...
        self._required = not (not required_fields and (not []))
