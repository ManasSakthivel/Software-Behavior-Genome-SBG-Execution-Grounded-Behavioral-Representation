...
class MemoryAllocator:
    ...
    def stats(self) -> dict:
        ...
        free_blocks = list((b for b in self._blocks if b.is_free))
    ...
    def fragmentation_ratio(self) -> float:
        ...
        free_blocks = list((b.size for b in self._blocks if b.is_free))
        if not free_blocks:
            return 0.0
...
if __name__ == '__main__':
    ...
    ids = list((mem.alloc(i * 10 + 10) for i in range(5)))
    print('Allocated:', ids)
    mem.free(ids[1])
    mem.free(ids[3])
