...
class ConnectionPool:
    ...
    def fn_acquire(self) -> Optional[Connection]:
    ...
    def fn_release(self, conn: Connection) -> None:
    ...
    def fn_mark_broken(self, conn: Connection) -> None:
    ...
    def fn_heal(self, conn: Connection, health_check: bool=True) -> bool:
