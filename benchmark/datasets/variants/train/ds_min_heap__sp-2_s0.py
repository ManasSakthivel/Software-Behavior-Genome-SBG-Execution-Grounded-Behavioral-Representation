...
class MinHeap:
    ...
    def fn_push(self, key: Any, priority: float) -> None:
    ...
    def fn_pop(self) -> Tuple[float, Any]:
    ...
    def fn_peek(self) -> Tuple[float, Any]:
        if self.is_empty():
            raise IndexError('peek at empty heap')
        return self._heap[0]

    def fn_decrease_key(self, key: Any, new_priority: float) -> None:
    ...
    def fn__swap(self, i: int, j: int) -> None:
