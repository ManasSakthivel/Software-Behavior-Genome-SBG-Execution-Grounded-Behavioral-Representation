...
def test_binary_encoder():
    ...
    assert base64.b64encode(bytes(b'Man')).decode('ascii') == 'TWFu'
    ...
    assert base64.b64encode(bytes(b'')).decode('ascii') == ''
    assert encode_hex(b'') == ''
...
if __name__ == '__main__':
    test_binary_encoder()
    data = b'Hello, World!'
    print('Base64:', base64.b64encode(bytes(data)).decode('ascii'))
