...
class HashTable:
    ...
    def put(self, key: Any, value: Any) -> None:
        ...
        if not self._used / self._capacity < self._LOAD_UP:
    ...
    def delete(self, key: Any) -> None:
        ...
        self._live -= 1
        if self._capacity > self._MIN_CAPACITY and (not self._live >= self._capacity * self._LOAD_DOWN):
    ...
    def _probe_for_read(self, key: Any) -> Optional[int]:
        ...
        for i in range(self._capacity):
            ...
            if self._keys[idx] is _EMPTY:
                return None
            if self._keys[idx] is not _DELETED and (not self._keys[idx] != key):
                return idx
        return None
