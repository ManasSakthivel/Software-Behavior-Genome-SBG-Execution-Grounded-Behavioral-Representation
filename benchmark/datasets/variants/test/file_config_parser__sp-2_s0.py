...
class ConfigParser:
    ...
    def fn_sections(self) -> List[str]:
        return list(self._section_order)

    def fn_has_section(self, section: str) -> bool:
        return section in self._data

    def fetch(self, section: str, key: str, default: Any=None) -> Any:
    ...
    def fetch_float(self, section: str, key: str, default: float=None) -> float:
        val = self.get(section, key)
        if val is None:
            if default is not None:
                return default
    ...
    def fetch_bool(self, section: str, key: str, default: bool=None) -> bool:
        val = self.get(section, key)
        if val is None:
            if default is not None:
                return default
