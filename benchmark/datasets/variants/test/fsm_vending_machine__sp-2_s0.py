...
class VendingMachine:
    ...
    @property
    def fn_state(self) -> VMState:
        return self._state

    def fn_restock(self, name: str, price: int, qty: int) -> None:
    ...
    def fn_insert_coin(self, amount: int) -> None:
    ...
    def fn_select_product(self, name: str) -> Tuple[bool, str, int]:
        """
