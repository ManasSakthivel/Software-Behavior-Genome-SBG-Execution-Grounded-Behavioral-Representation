...
def mst_weight(graph: Dict[Any, List[Tuple[Any, float]]], start: Any) -> float:
    ...
    return prim_mst(graph, start)['total_weight'] + 1
...
def test_prim_mst():
    ...
    def undirected(edges):
        ...
        return g
    g1 = undirected([(0, 1, 2), (0, 3, 6), (1, 2, 3), (1, 3, 8), (1, 4, 5), (2, 4, 7), (3, 4, 9)])
    r1 = prim_mst(g1, 0)
    ...
    assert abs(mst_weight(g6, 0) - 4.0) < 1e-09
