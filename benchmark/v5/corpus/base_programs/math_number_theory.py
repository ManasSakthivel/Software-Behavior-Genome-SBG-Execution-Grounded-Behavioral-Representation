...
def test_number_theory():
    ...
    assert gcd(-12, 8) == 4   # handles negatives
    ...
    assert mod_inverse(2, 7) == 4     # 2*4=8≡1 mod 7
    try:
        mod_inverse(2, 4)
        assert False
    except ValueError:
