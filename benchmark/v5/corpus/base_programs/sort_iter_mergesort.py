# program_id: sort_iter_mergesort
...
def _merge_adjacent(arr: list, left: int, mid: int, right: int,
                    buf: list) -> None:
...
def test_iter_mergesort():
    ...
    # Test 9: matches Python's sorted() on random input
    import random
