...
class CleanupRegistry:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb) -> bool:
        try:
            ...
            if exc_val is None:
                raise
            # Chain: original exception takes priority
...
def test_resource_guard():
    # Test 1: basic acquire/release lifecycle
    ...
    # Test 2: resource is released even when exception raised inside block
    ...
    # Test 3: double-acquire raises RuntimeError
    ...
    # Test 4: double-release raises RuntimeError
    ...
    # Test 5: CleanupRegistry — LIFO order
    order = []
    reg = CleanupRegistry()
    ...
    # Test 6: CleanupRegistry collects multiple errors
    def failing(n):
    ...
    # Test 7: CleanupRegistry as context manager — normal path
    ...
    # Test 8: CleanupRegistry as context manager — exception path
    ...
    try:
        ...
        pass
    assert r6.is_open is False  # cleanup still ran

    # Test 9: empty registry — run_all returns empty list
