...
def test_counting_sort():
    ...
    # Test 6: negative integers (auto-inferred range)
    assert counting_sort([-3, -1, -2, 0, 2]) == [-3, -2, -1, 0, 2]

    # Test 7: explicit range violation raises
    try:
