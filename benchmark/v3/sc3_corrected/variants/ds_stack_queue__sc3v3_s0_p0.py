...
def test_deque():
    ...
    assert d.is_empty()
    try: d.pop_front(); assert False
    except EmptyError: pass
    try: d.pop_back(); assert False
    except EmptyError: pass
...
def test_all():
    ...
    # Additional: queue FIFO correctness
    q = Queue()
    for i in range(10):
        q.enqueue(i)
    for i in range(10):
    ...
    # Additional: stack LIFO correctness
    s = Stack()
    for i in range(10):
        s.push(i)
