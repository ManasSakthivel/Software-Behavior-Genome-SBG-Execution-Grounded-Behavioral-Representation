# program_id: graph_topological_sort
...
def test_topological_sort():
    ...
    # Test 1: Kahn produces valid order
    ...
    # Test 4: cycle raises CycleError (DFS)
    try:
