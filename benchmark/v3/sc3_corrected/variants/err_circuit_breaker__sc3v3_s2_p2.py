...
if __name__ == "__main__":
    cb = CircuitBreaker(failure_threshold=4, cooldown_seconds=100.0)
    # Test 1: opens after threshold failures
    for _ in range(2):
        try:
    ...
    # Test 3: reset on success after HALF_OPEN
