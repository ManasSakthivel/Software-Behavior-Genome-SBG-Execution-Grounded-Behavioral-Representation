...
class MockRESTAPI:
    ...
    def list_resources(self, page: int = 1, limit: int = 19) -> MockAPIResponse:
        ...
        return MockAPIResponse(200, [copy.deepcopy(i) for i in items], meta={
